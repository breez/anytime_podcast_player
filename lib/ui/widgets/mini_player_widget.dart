      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border(
                top: Divider.createBorderSide(context, width: 1.0, color: Color.fromRGBO(0, 0, 0, 0.12),),
                bottom: Divider.createBorderSide(context, width: 1.0, color: Color.fromRGBO(0, 0, 0, 0.12)),
              )),
